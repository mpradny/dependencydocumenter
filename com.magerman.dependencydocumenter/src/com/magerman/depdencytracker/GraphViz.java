 ...
 * </dl>
 * 
 * @version v0.4, 2011/02/05 (February) -- Patch of Keheliya Gallaba is added. Now you can specify the type of the output file: gif, dot,
 *          fig, pdf, ps, svg, png, etc.
...
public class GraphViz {
     ...
     */
    // TODO Find better temp directory
    private final static String TEMP_DIR = "c:\\TEMP"; // Windows
     ...
     */
    public final String getDotSource() {
     ...
     */
    public final void addln(final String line) {
        graph.append(line + "\n");
    }
     ...
     */
    public final byte[] getGraph(final String dot_source, final String type) {
        File dot;
     ...
     */
    public final int writeGraphToFile(final byte[] img, final String file) {
     ...
     * @return Success: 1, Failure: -1
     */
    public final int writeGraphToFile(final byte[] img, final File to) {
        try {
    ...
    private byte[] get_img_stream(final File dot, final String type) {
        ...
        try {
            ...
            String[] args = { getPathToDotExe(), "-T" + type, dot.getAbsolutePath(), "-o", img.getAbsolutePath() };
     ...
     */
    public final String start_graph() {
        return "digraph G {";
    }
     ...
     */
    public final void readSource(final String input) {
